...
### 9. แผนพัฒนา(Creative Solution + SMART KPI)
...
| Potential Change (สรุปสั้น 1 บรรทัด) | Goal (เป้าหมาย) | Key Actions (2–4 ข้อ) | Owner | Timeline | SMART KPI (1–2 ตัว + นิยาม/สูตร) |
|---|---|---|---|---|---|
| ... | ... | 1) ...<br>2) ...<br>3) ... | ... | ... | - KPI1: ... (นิยาม/สูตร: ...)<br>- KPI2: ... (นิยาม/สูตร: ...) |
...
def get_consultation_response(incident_description: str) -> str:
    ...
    **แนวทางการตอบ:**
    ...
    3. **หากข้อมูลไม่พอ ให้ระบุ "ข้อมูลที่ควรถามเพิ่ม" แบบสั้น ๆ ในท้ายหัวข้อ 8 เท่านั้น (ไม่่ต้องถามกลับผู้ใช้)
