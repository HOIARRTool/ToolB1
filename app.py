...
def display_user_guide():
    ...
    **HOIA-RR (Hospital Occurrence/Incident Analysis & Risk Register)** คือเครื่องมือวิเคราะห์และจัดการอุบัติการณ์ความเสี่ยงในโรงพยาบาล ที่ถูกออกแบบมาเพื่อเปลี่ยนข้อมูลดิบให้กลายเป็นข้อมูลเชิงลึกที่นำไปปฏิบัติได้จริง ช่วยให้ผู้บริหารและผู้รับผิดชอบความเสี่ยง (Risk Owner) สามารถมองเห็นภาพรวม, ติดตามแนวโน้ม และตัดสินใจได้อย่างมีประสิทธิภาพ
    ...
    - **AI ผู้ช่วยให้คำปรึกษา**: มาพร้อมกับ AI สองรูปแบบ คือ `RCA Helpdesk` สำหรับให้คำปรึกษาอุบัติการณ์ ซึ่งจะมีรายละเอียดได้แก่ รหัสที่แนะนำสำหรับลงอุบัติการณ์อ้างอิงตาม NRLS, สาเหตุหรือ contributing factor, คำแนะนำสำหรับการแก้ไขเบื้องต้น และการเรียนรู้ไปกับ 3P Safety & HA Standard 
    - **Risk Register Assistant** สำหรับช่วย Risk Owner ค้นหาข้อมูลเชิงลึกของอุบัติการณ์ที่ดูแลอยู่ (Review อุบัติการณ์ในช่วงเวลาที่เลือก) พร้อมคำแนะนำสำหรับ Risk Transfer & Prevention และ Risk Monitor  
    ...
    **ขั้นตอน:**
    ...
    | **หมวดหมู่และสถานะการแก้ไข** | **ติดตามความคืบหน้าในการแก้ไขปัญหา**: เจาะลึกว่าอุบัติการณ์ในแต่ละหมวดหมู่ (โดยเฉพาะ PSG9) ถูกแก้ไขไปแล้วกี่เปอร์เซ็นต์ และมีเคสใดค้างอยู่บ้างเพื่อทำการติดตามได้อย่างครอบคลุม  |
...
def display_admin_page():
    ...
    # คำแนะนำ HRMS (ตัวใหญ่ขึ้น + bullet)
    st.markdown("""
    <div style="font-size:16px">
      <ul>
        ...
        <li>ดาวน์โหลดไฟล์และบันทึกเป็น <b>.csv</b> (เลือก CSV UTF-8 (Comma delimited) (*csv))</li>
        <li>นำไฟล์ที่ได้มาอัปโหลดที่นี่</li>
      </ul>
    </div>
    """, unsafe_allow_html=True)
