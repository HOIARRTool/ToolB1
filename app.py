...
def display_user_guide():
    ...
    **ขั้นตอน:**
    ...
    | **Risk Matrix (Interactive)** | **เห็นการกระจายตัวของความเสี่ยง**: แสดง Risk Matrix (I : F) ที่คุณสามารถคลิกที่ตัวเลขในช่องต่างๆ เพื่อเจาะลึกดูรายการอุบัติการณ์ในระดับความเสี่ยงนั้นๆ ได้ทันที |
